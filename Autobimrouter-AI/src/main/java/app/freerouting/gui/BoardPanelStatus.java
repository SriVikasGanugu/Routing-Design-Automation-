...
class BoardPanelStatus extends JPanel
{
  ...
  BoardPanelStatus(Locale locale)
  {
    ...
    errorsWarningsPanel.setBackground(Color.BLACK);
    errorsWarningsPanel.setForeground(Color.WHITE);

    // Load the Material Icons for warnings and errors
    warningIcon = new JLabel();
    warningIcon.setForeground(Color.orange);
    ...
    additionalMessage.setForeground(Color.white);
    ...
    currentLayer.setForeground(Color.white);
