...
//  private final SegmentedButtons unitSelectionPanel;
  ...
  BoardToolbar(BoardFrame p_board_frame, boolean p_disable_select_mode)
  {
    ...
    final JToolBar left_toolbar = new JToolBar(JToolBar.VERTICAL);
    left_toolbar.setBackground(Color.BLACK);

    left_toolbar.setMaximumSize(new Dimension(1200, 30));

    if (!p_disable_select_mode)
    {
      modeSelectionPanel = new SegmentedButtons(tm, null, "select_button", "route_button", "drag_button");
    }
    else
    {
      modeSelectionPanel = new SegmentedButtons(tm, null, "route_button", "drag_button");
    }
    ...
    this.add(left_toolbar, BorderLayout.PAGE_END);

    // murad add logo
    // Load the logo icon
    ImageIcon originalIcon  = new ImageIcon("design/icon/freerouting_icon_256x256_v3.png");
    ...
    final JToolBar middle_toolbar = new JToolBar(JToolBar.VERTICAL);
    middle_toolbar.setBackground(Color.BLACK);

    // Add Logo
    middle_toolbar.add(logoLabel);
    ...
    toolbar_autoroute_button.setBackground(Color.BLACK);
    toolbar_autoroute_button.setForeground(new Color(249, 155, 28));
    ...
    delete_all_tracks_button.setForeground(Color.red);
    delete_all_tracks_button.setBackground(Color.BLACK);
    ...
    toolbar_undo_button.setForeground(new Color(249, 155, 28));
    toolbar_undo_button.setBackground(Color.BLACK);
    ...
    toolbar_redo_button.setForeground(new Color(249, 155, 28));
    toolbar_redo_button.setBackground(Color.BLACK);
    ...
    toolbar_incompletes_button.setForeground(new Color(249, 155, 28));
    toolbar_incompletes_button.setBackground(Color.BLACK);
    ...
    toolbar_violation_button.setForeground(new Color(249, 155, 28));
    toolbar_violation_button.setBackground(Color.BLACK);
    ...
    toolbar_display_region_button.setForeground(new Color(249, 155, 28));
    toolbar_display_region_button.setBackground(Color.BLACK);
    ...
    toolbar_display_all_button.setForeground(new Color(249, 155, 28));
    toolbar_display_all_button.setBackground(Color.BLACK);
    ...
    settings_button.setForeground(new Color(249, 155, 28));
  ...
  // murad remove unit from toolbar
