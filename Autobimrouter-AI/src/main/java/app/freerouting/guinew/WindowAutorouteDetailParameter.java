...
public class WindowAutorouteDetailParameter extends BoardSavableSubWindow
{
   ...
   */
  public WindowAutorouteDetailParameter(MainFrame p_board_frame)
  {
    ...
    this.setTitle("Detail Auto-route Parameter");
    ...
    JLabel via_cost_label = new JLabel("via_costs");
    gridbag.setConstraints(via_cost_label, gridbag_constraints);
    main_panel.add(via_cost_label);

    NumberFormat number_format = NumberFormat.getIntegerInstance(Locale.getDefault());
    ...
    JLabel plane_via_cost_label = new JLabel("plane_via_costs");
    ...
    JLabel start_pass_label = new JLabel("start_pass");
    ...
    start_ripup_costs_label.setText("start_ripup_costs");
    ...
    this.speed_fast = "Fast";
    this.speed_slow = "Slow";
    ...
    JLabel layer_label = new JLabel("trace_costs_on_layer");
    ...
    JLabel pref_dir_label = new JLabel("in_preferred_direction");
    ...
    JLabel against_pref_dir_label = new JLabel("against_preferred_direction");
