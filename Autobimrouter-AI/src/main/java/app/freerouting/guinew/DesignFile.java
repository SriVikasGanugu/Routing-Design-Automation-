...
//  public static CRC32 CalculateCrc32(InputStream inputStream) // original
//  {
//    CRC32 crc = new CRC32();
//    try
//    {
...
//  }
  ...
  public static CRC32 CalculateCrc32(InputStream inputStream) {
    CRC32 crc = new CRC32();
    try {
      byte[] buffer = new byte[8192]; // Create a buffer (8 KB is a reasonable size, but you can adjust it)
      int bytesRead;
      // Read the input stream in chunks instead of byte by byte
  ...
  public static boolean read_rules_file(String p_design_name, String p_parent_name, String rules_file_name, BoardHandling p_board_handling, Boolean p_confirm_message)
  {
    ...
    try
    {
      ...
      if (dsn_file_generated_by_host && p_confirm_message)
      {
